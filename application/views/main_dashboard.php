...
<body>
    ...
    <div class="main-container">
        ...
        <main class="main-content">
            ...
            <div class="table-container" style="margin-top: 1.5rem;">
                <h3 class="table-title">Button Examples</h3>
    ...
    <script>
        ...
        const submenuToggles = document.querySelectorAll('.menu-item > .menu-link > .submenu-arrow');
        ...
        // Initialize DataTable (you would include the actual DataTables library in a real project)
        console.log("DataTable would be initialized here with jQuery in a real project");
    </script>
</body>
</html>