        ...
        <div class="modal modal-lg">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">Satuan Dus</label>
                            <input type="number" class="form-control" placeholder="Masukan berapa dus" id="dusid">
                            <div style="margin-top:6px;">
                                <input type="checkbox" id="duscek" value="dus">
                                <label for="duscek">Identifikasi Barcode</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Satuan Pack</label>
                            <input type="number" class="form-control" placeholder="Masukan berapa pack" id="packid">
                            <div style="margin-top:6px;">
                                <input type="checkbox" id="packcek" value="pack">
                                <label for="packcek">Identifikasi Barcode</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Satuan Pcs (Satuan pemakaian)</label>
                            <input type="number" class="form-control" style="border:1px solid red;" placeholder="Masukan berapa Pcs" id="pcsid">
                            <div style="margin-top:6px;">
                                <input type="checkbox" id="pcscek" value="pack">
                                <label for="pcscek">Identifikasi Barcode</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Masukan Barcode / QR Code" id="codeid">
                        </div>
                        <div class="form-group" >
                            <label class="form-label">&nbsp;</label>
                            <a href="javascript:void(0);" style="color:red;font-size:13px;" id="generateBtn">Generate QR Code</a>
                        </div>
                    </div>
                    <div id="qrcodeview"></div>
                    <p class="generated-data" id="generated_data_display"></p>
                    <!-- <div class="form-group">
