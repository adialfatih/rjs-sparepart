...
<head>
    ...
    <title>Scan Untuk Pemakaian Sparepart Departement Spinning</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <p>Scan Kode untuk pemakaian Spinning</p>
        ...
        <div class="footer">
            &copy; <?=date('Y');?>Rindang Jati Spinning
        </div>
    </div>
            ...
            function onScanSuccess(decodedText, decodedResult) {
                ...
                if (decodedText.startsWith('http://') || decodedText.startsWith('https://')) {
                    ...
                    $.ajax({
                        ...
                        type: 'get',
                        data: { "dep":"Spinning", decodedText: decodedText },
